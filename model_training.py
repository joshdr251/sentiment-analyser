...
while True:
    try:
        filepath_input = "imdb_dataset_50000_cleaned.csv" #input("Input filepath: ")
...
# creating vectorizer
vectorizer = TfidfVectorizer(max_features=50000)  # stop_words removes words with little meaning
